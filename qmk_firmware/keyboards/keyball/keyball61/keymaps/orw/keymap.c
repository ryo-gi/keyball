...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LCTL  , KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,                                   KC_H     , KC_J     , KC_K     , KC_L     , SFT_SCLN , KC_RSFT  ,
    KC_LSFT  , KC_Z     , CTL_X    , KC_C     , KC_V     , KC_B     , KC_F15    ,              KC_F16 , KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_TAB   ,
    GUI_S    , KC_LWIN  , KC_LALT  , _______  , L1_LNG2  , L2_BSPC  , L3_LNG1   ,              KC_ENT , L1_SPC   , _______  , _______  , _______  , TG(4)    , L3_VOLD 
  ),
  //記号
  [1] = LAYOUT_universal(
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , KC_PLUS  , KC_7     , KC_8     , KC_9     , KC_CIRC  ,                                   KC_PGUP  , KC_HOME  , KC_UP    , KC_END   , _______  , KC_F12   ,
    _______  , KC_MINS  , KC_4     , KC_5     , KC_6     , KC_SLSH  ,                                   KC_PGDN  , KC_LEFT  , KC_DOWN  , KC_RGHT  , _______  , _______  ,
    _______  , KC_0     , KC_1     , KC_2     , KC_3     , KC_ASTR  ,  _______  ,             _______ , _______  , KC_BTN1  , KC_BTN3  , KC_BTN2  , _______  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  ,  _______  ,             _______ , _______  , _______  , _______  , _______  , _______  , _______
  ),

  [3] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______  , _______  ,                                   _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , CPI_D1K  , KC_MSTP  , KC_BRIU  , KC_VOLU  , _______  ,                                   _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , CPI_D100 , KC_MPLY  , KC_BRID  , KC_VOLD  , _______  ,                                   _______  , KC_BTN1  , _______  , KC_BTN2  , KBC_SAVE , KBC_RST  ,
    _______  , CPI_I100 , _______  , _______  , KC_MUTE  , _______  ,  _______  ,            _______  , _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , CPI_I1K  , SCRL_DVD , SCRL_DVI , SCRL_MO  , SCRL_TO  ,  _______  ,            _______  , KC_BSPC  , _______  , _______  , _______  , _______  , _______
  ),

  // //ワカサギ配列
  //習得コスト高すぎなので挫折 20240101
  // [4] = LAYOUT_universal( 
  //   _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
  ...
  //   _______  , KC_SLSH  , KC_COMM  , KC_L     , KC_G     , KC_J     , _______  ,            _______  , KC_F     , KC_V     , KC_SCLN  , KC_Z     , KC_DOT   , _______  ,
  ...
  [4] = LAYOUT_universal(
    KC_ESC     , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
    KC_TAB     , KC_Q     , KC_L        , KC_U     , KC_COMM        , KC_DOT        ,                                       KC_F         , KC_W     , KC_R     , KC_Y    , KC_P           , _______  ,
    KC_LCTL    , KC_E     , KC_I        , KC_A     , KC_O           , KC_MINS       ,                                       KC_K         , KC_T     , KC_N     , KC_S    , SFT_T(KC_H), KC_RSFT  ,
    KC_LSFT    , KC_Z     , CTL_T(KC_X) , KC_C     , KC_V           , KC_SCLN       , KC_F15        ,              KC_F16 , KC_G         , KC_D     , KC_M     , KC_J    , KC_B       , KC_TAB   ,
    GUI_S    , KC_LWIN  , KC_LALT  , _______  , L1_LNG2  , L2_BSPC  , L3_LNG1   ,              KC_ENT , L1_SPC   , _______  , _______  , _______  , TG(4)    , L3_VOLD 
  ),
