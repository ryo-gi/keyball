...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_universal(
    ...
    _______  , CPI_I100 , _______  , _______  , KC_MUTE  , _______  , _______  ,            _______  , _______  , A(KC_TAB) , _______  , _______  , _______  , _______  ,
  ...
  [4] = LAYOUT_universal(
    ...
    SGUI(KC_S) , KC_LWIN  , KC_LALT     , _______  , LT(1,KC_LNG2)  , LT(2,KC_BSPC) , LT(3,KC_LNG1) ,              KC_ENT , LT(1,KC_SPC) , _______  , _______  , _______ , KC_TRNS    , LT(3,KC_VOLD)
  ),
