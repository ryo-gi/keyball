...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LCTL    , KC_A     , KC_S        , KC_D     , KC_F           , KC_A          ,                                       KC_H         , KC_J     , KC_K     , KC_L     , LSFT_T(KC_SCLN), KC_RSFT  ,
    KC_LSFT    , KC_Z     , CTL_T(KC_X) , KC_C     , KC_V           , KC_B          , KC_F15        ,              KC_F16 , KC_N         , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH        , KC_TAB   ,
    SGUI(KC_S) , KC_LWIN  , KC_LALT     , KC_A   , LT(1,KC_LNG2)  , LT(2,KC_BSPC) , LT(3,KC_LNG1) ,              KC_ENT , LT(1,KC_SPC) , _______  , _______  , _______  , TG(4)  , LT(3,KC_VOLD)
  ),
 ...
 */
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , KC_0     , KC_1     , KC_2     , KC_3     , KC_DOT   , _______  ,             _______ , KC_PGDN  , KC_BTN1  , KC_BTN3  , KC_BTN2  , KC_PGUP  , _______  ,
...
//ワカサギ配列
  [4] = LAYOUT_universal( 
    ...
    _______  , _______  , _______  , KC_1     , _______  , _______  , _______  ,            _______  , _______  , _______  , _______  , _______  , KC_TRNS  , _______
  ),
  ...
  [7] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , ALT_T(KC_TAB)  , _______  , _______  , _______  ,
